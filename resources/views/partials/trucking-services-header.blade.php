                                ...
                                <ul class="nav navbar-nav">
                                    <li class="dropdown current-menu-item">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="{{route('trucking-services-overview.index')}}">Trucking
                                                    services overview</a></li>
                                            <li><a href="{{route('trucking-video-slider.index')}}">Trucking video
                                                    slider</a></li>
                                            <li><a href="{{route('trucking-home-simple.index')}}">Trucking home
                                                    simple</a></li>
                                            <li><a href="{{route('trucking-services-slider.index')}}">Trucking services
                                                    slider</a></li>
                                            <li><a href="{{route('trucking-parallax-slider.index')}}">Trucking parallax
                                                    slider</a></li>
                                            <li><a href="{{route('trucking-vehicle-fleet.index')}}">Trucking Vehicle
                                                    Fleet</a></li>
                                            <li><a href={{route('trucking-corporate.index')}}>Trucking corporate</a>
                                            </li>
                                            <li><a href="{{route('trucking-simple-slider.index')}}">Trucking simple
                                                    slider</a></li>
                                            <li><a href="{{route('fullscreen-minimal.index')}}">Fullscreen minimal</a>
                                            </li>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="dropdown dropdown-submenu">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="header-default-top-bar.html">Header default top bar</a>
                                                    </li>
                                                    <li><a href="index08.html">Header simple light bar</a></li>
                                                    <li><a href="header-simple-dark-bar.html">Header simple dark bar</a>
                                                    </li>
                                                    <li><a href="header-simple-dark.html">Header simple dark</a></li>
                                                    <li><a href="header-menu-bottom.html">Header menu bottom light</a>
                                                    </li>
                                            ...
                                            <li><a href="{{route('about-compact.index')}}">About compact</a></li>
                                            <li><a href="{{route('about-sidebar.index')}}">About with sidebar</a></li>
                                            <li><a href="{{route('simple-page-title.index')}}">Simple page title</a>
                                            </li>
                                            <li><a href="{{route('company-history.index')}}">Company history</a></li>
                                            <li><a href="{{route('company-events.index')}}">Company Events</a></li>
                                            <li><a href="{{route('company-clients.index')}}">Company Clients</a></li>
