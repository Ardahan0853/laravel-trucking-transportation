                    ...
                    <div class="blog-post clearfix">
                        <div class="post-media">
                            <a href="news-single.html" class="post-img">
                                <img src="{{asset('img/blog/post-img01.jpg')}}"
                        ...
                        <div class="post-comments">
                            ...
                            <ul class="comments-li">
                                <li>
                                    <div class="comment">
                                        <div class="avatar">
                                            <img src="{{asset('img/blog/avatar01.png')}}" alt="author"/>
                                        </div>
                                    ...
                                    <ul class="children">
                                        <li>
                                            <div class="comment">
                                                <div class="avatar">
                                                    <img src="{{asset('img/blog/avatar02.png')}}" alt="author"/>
                                                </div>
                            ...
                            <div id="respond">
                                ...
                                <form id="commentform">
                                    ...
                                    <fieldset class="wpcf7-message">
                                        ...
                                        <textarea name="comment" class="wpcf7-textarea" id="comment-message"
                                                  rows="8"></textarea>
                                    </fieldset>
