                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                <img class="float-right" src="{{asset('img/pics/img30.jpg')}}" alt=""/>
                                ...
                                expound the actual teachings of the great
                                explorer of the truth, the master-builder
                                of human happiness. A wonderful serenity
                                has taken possession of my entire soul,
                                like these sweet mornings of spring which I
                                enjoy with my whole heart. "But I must
