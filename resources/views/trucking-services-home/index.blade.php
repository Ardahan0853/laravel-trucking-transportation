...
@section('content')
    <div id="masterslider" class="master-slider ms-skin-default mb-0">
        ...
        <div class="ms-slide">
            <!-- slide background -->
            <img src="{{asset('masterslider/blank.gif')}}" data-src="{{asset('img/slider/slide02.jpg')}}"
                 alt="International Air freight"/>

            <h2 class="ms-layer pi-caption01"
                style="left: 58px; top: 390px; font-size: 59px;"
                data-type="text"
                data-effect="top(short)"
                data-duration="300"
                data-hide-effect="fade"
                data-delay="0"
            >International Air Freight</h2>
        ...
        <div class="ms-slide">
            <!-- slide background -->
            <img src="{{asset('masterslider/blank.gif')}}" data-src="{{asset('img/slider/slide03.jpg')}}"
        ...
        <div class="ms-slide">
            <!-- slide background -->
            <img src="{{asset('masterslider/blank.gif')}}" data-src="{{asset('img/slider/slide04.jpg')}}"
                 alt="Worldwide freight services"/>
        ...
        <div class="container">
            <div class="row services-negative-top">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="service-feature-box">
                        <div class="service-media">
                            <img src="{{asset('img/pics/img02.jpg')}}" alt="Trucking"/>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="service-feature-box">
                        <div class="service-media">
                            <img src="{{asset('img/pics/img03.jpg')}}" alt="Trucking"/>
        ...
        <div class="container">
            ...
            <div class="row mb-30">
                <div class="col-md-6 col-sm-6">
                    <div class="service-icon-left-boxed">
                        <div class="icon-container animated triggerAnimation" data-animate="zoomIn">
                            <img src="{{asset('img/svg/pi-checklist-2.svg')}}" alt="checklist icon"/>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="service-icon-left-boxed">
                        <div class="icon-container animated triggerAnimation" data-animate="zoomIn">
                            <img src="{{asset('img/svg/pi-globe-5.svg')}}" alt="globe icon"/>
                        </div><!-- .icon-container end -->
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="service-icon-left-boxed">
                        <div class="icon-container animated triggerAnimation" data-animate="zoomIn">
                            <img src="{{asset('img/svg/pi-forklift-truck-5.svg')}}" alt="forktruck icon"/>
                        </div><!-- .icon-container end -->
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="service-icon-left-boxed">
                        <div class="icon-container animated triggerAnimation" data-animate="zoomIn">
                            <img src="{{asset('img/svg/pi-touch-desktop.svg')}}" alt="touch icon"/>
                        </div><!-- .icon-container end -->
                    ...
                    <ul class="service-list clearfix">
                        <li>
                            <div class="icon-container">
                                <img class="svg-white" src="{{asset('img/svg/pi-cargo-box-2.svg')}}" alt="icon"/>
                            </div><!-- .icon-container end -->
                        ...
                        <li>
                            <div class="icon-container">
                                <img class="svg-white" src="{{asset('img/svg/pi-mark-energy.svg')}}" alt="icon"/>
                            </div><!-- .icon-container end -->
                        ...
                        <li>
                            <div class="icon-container">
                                <img class="svg-white" src="{{asset('img/svg/pi-food-beverage.svg')}}" alt="icon"/>
                            </div><!-- .icon-container end -->
                        ...
                        <li>
                            <div class="icon-container">
                                <img class="svg-white" src="{{asset('img/svg/pi-cargo-retail.svg')}}" alt="icon"/>
                            </div><!-- .icon-container end -->
                        ...
                        <li>
                            <div class="icon-container">
                                <img class="svg-white" src="{{asset('img/svg/pi-truck-8.svg')}}" alt="icon"/>
                            </div><!-- .icon-container end -->
                    ...
                    <ul class="pi-latest-posts clearfix">
                        <li>
                            <div class="post-media">
                                <img src="{{asset('img/blog/latest01.jpg')}}" alt=""/>
                            </div><!-- .post-media end -->
                        ...
                        <li>
                            <div class="post-media">
                                <img src="{{asset('img/blog/latest02.jpg')}}" alt=""/>
                            </div><!-- .post-media end -->
